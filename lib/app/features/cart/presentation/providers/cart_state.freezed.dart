...
mixin _$CartState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CartItemEntity> items) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CartItemEntity> items)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<CartItemEntity> items) : _items = items;
...
abstract class _Loaded implements CartState {
  const factory _Loaded(final List<CartItemEntity> items) = _$LoadedImpl;
