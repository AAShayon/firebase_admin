...
mixin _$OrderState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<OrderItemEntity> items) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<OrderItemEntity> items)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<OrderItemEntity> items});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<OrderItemEntity> items) : _items = items;
...
abstract class _Loaded implements OrderState {
  const factory _Loaded(final List<OrderItemEntity> items) = _$LoadedImpl;
